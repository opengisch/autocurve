...
<qgis labelsEnabled="0" version="3.28.1-Firenze" styleCategories="Symbology|Labeling">
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" type="singleSymbol" forceraster="0">
    <symbols>
      <symbol frame_rate="10" name="0" force_rhr="0" alpha="1" is_animated="0" type="line" clip_to_extent="1">
        ...
        <layer pass="0" class="MarkerLine" enabled="1" locked="0">
          ...
          <symbol frame_rate="10" name="@0@1" force_rhr="0" alpha="1" is_animated="0" type="marker" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer pass="0" class="MarkerLine" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="place_on_every_part" type="bool" value="true"/>
            <Option name="placements" type="QString" value="CurvePoint"/>
            <Option name="ring_filter" type="QString" value="0"/>
            <Option name="rotate" type="QString" value="1"/>
          </Option>
          <data_defined_properties>
          ...
          <symbol frame_rate="10" name="@0@2" force_rhr="0" alpha="1" is_animated="0" type="marker" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
            ...
            <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option name="horizontal_anchor_point" type="QString" value="1"/>
                <Option name="joinstyle" type="QString" value="bevel"/>
                <Option name="name" type="QString" value="decagon"/>
                <Option name="offset" type="QString" value="0,0"/>
                <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
                <Option name="offset_unit" type="QString" value="MM"/>
                <Option name="outline_color" type="QString" value="35,35,35,255"/>
